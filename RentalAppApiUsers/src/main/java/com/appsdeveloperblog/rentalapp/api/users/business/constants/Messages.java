package com.appsdeveloperblog.rentalapp.api.users.business.constants;
...
public class Messages {
    ...
    public static final String BRANDGET = "Brand found";
    public static final String BRANDNOTFOUND = "BRAND NOT FOUND.";
    public static final String BRANDDELETEERROR = "Car of this brand found";
    ...
    public static final String CARBRANDANDCOLORLIST = "Car Detail Listed by Brandname And Colorname.";
    public static final String CARGETBRAND = "Car get by Brand Id.";
    public static final String CARGETCOLOR = "Car get by Color Id.";
    public static final String CARGETCITY = "Car get by City Id.";
    public static final String CARKMUPDATE = "Car Km updated.";
    public static final String CARDONOTRETURNFROMRENTAL = "Car Do Not Return From Rental.";
    public static final String CARAVAILABLE = "Car Available";
    ...
    public static final String COLORGET = "Color found";
    ...
    public static final String INVOICENOTADD = "Already make out an invoice.";
    ...
    public static final String ADDITIONALSERVICEFOUND = "Additional service found";
